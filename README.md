...
#### Clone the repo
```
$ git clone https://github.com/rohit-motwani/Diet_Recommendation
```
### docker-compose
...
```
Then open localhost:8501 and enjoy :smiley:.

PS: You should have docker and docker-compose already installed
### Use the hosted version on Streamlit Cloud

https://fitness-ai-recommendation-20.streamlit.app/Diet_Recommendation
